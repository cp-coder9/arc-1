...
- [x] **Task 2.5** — Add "Coordination" tab to `ArchitectDashboard.tsx`
  - New `TabsContent value="coordination"`
  - Embeds `ResponsibilityMatrix` and `TeamBuilder`
  - Shows coverage summary

- [x] **Task 2.6** — Update sidebar navigation in `App.tsx`
