...
- [x] **Task 4.1** — Define construction types in `src/types.ts`
  - `GanttTask` interface
  - `SiteLog` interface
...
- [x] **Task 4.2** — Create `src/services/constructionService.ts`
...
- [x] **Task 4.3** — Create `src/components/GanttChart.tsx`
...
- [x] **Task 4.4** — Create `src/components/SiteLogManager.tsx`
  - Date-sorted log list
  - New log dialog (weather, description, photos)
  - Photo gallery per entry
  - Pagination

- [x] **Task 4.5** — Create `src/components/RFIManager.tsx`
