...
- [x] 1. Design System foundation — Theme_Tokens, CSS, and token guard
  - [x] 1.1 Add fast-check dependency and additive Theme_Tokens + `.glass` utility to `src/index.css`
  ...
  - [x] 1.2 Create token name constants + runtime resolve guard (`src/design-system/tokens.ts`)
  ...
  - [x] 1.3 Write unit tests for the token resolve guard
...
- [x] 2. Glass and Bird_Mark primitives
  - [x] 2.1 Implement `GlassSurface` primitive (`src/design-system/GlassSurface.tsx`)
  ...
  - [x] 2.2 Write unit tests for GlassSurface layers and fallback
  ...
  - [x] 2.3 Implement `BirdMark` primitive (`src/design-system/BirdMark.tsx`)
  ...
  - [x] 2.4 Write unit tests for BirdMark fallback, alt text, and interactivity
...
- [x] 3. Theme system (Dark default + Light option)
  - [x] 3.1 Implement `ThemeProvider` + `useTheme` + pre-paint bootstrap
  ...
  - [x] 3.2 Implement `ThemeToggle` (`src/design-system/theme/ThemeToggle.tsx`)
  ...
  - [x] 3.4 Write example tests for ThemeToggle and theme application
...
- [x] 4. Design System invariant property tests
  - [x] 4.1 Write property test for token integrity
  ...
  - [x] 4.2 Write property test for text contrast in every Theme_Mode
...
- [x] 5. Checkpoint — Design System layer
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Landing copy module
  - [x] 6.1 Implement `copy.ts` with `HERO_COPY` and `clampCopy` (`src/features/landing/copy.ts`)
  ...
  - [x] 6.2 Write property test for copy clamp
...
- [x] 7. Flock geometry (pure functions)
  - [x] 7.1 Implement `geometry.ts` (`src/features/landing/flock/geometry.ts`)
  ...
  - [x] 7.2 Write property test for flock plan bounds and settle opacity
  ...
  - [x] 7.3 Write property test for agent paths staying on the grid
...
- [x] 8. Background layers
  - [x] 8.1 Implement `GridBackground` + `NetworkNodes`
  ...
  - [x] 8.2 Implement `AmbientBlobs` + `Scrim`
...
- [x] 9. Flock activation engine
  - [x] 9.1 Implement `useFlockActivation` state machine + watchdog (`src/features/landing/flock/useFlockActivation.ts`)
  ...
  - [x] 9.2 Implement `AgentField` render + animation (`src/features/landing/flock/AgentField.tsx`)
  ...
  - [x] 9.3 Write property test for activation round-trip
...
- [x] 10. Checkpoint — pure logic and animation engine
  - Ensure all tests pass, ask the user if questions arise.

- [x] 11. Landing UI components
  - [x] 11.1 Implement `TopBar` (`src/features/landing/TopBar.tsx`)
  ...
  - [x] 11.2 Implement `Hero` + `OrbitRing` (`src/features/landing/Hero.tsx`)
  ...
  - [x] 11.3 Implement `QuickNav` (`src/features/landing/QuickNav.tsx`)
  ...
  - [x] 11.4 Implement `OSRevealCard` (`src/features/landing/OSRevealCard.tsx`)
...
- [x] 12. Landing composition (responsive + reduced motion + z-order)
  - [x] 12.1 Implement `LandingPage` (`src/features/landing/LandingPage.tsx`)
...
- [x] 13. App integration
  - [x] 13.1 Wire `ThemeProvider` and mount `LandingPage` in `App.tsx`
...
- [x] 14. Accessibility and behavior property tests
  - [x] 14.1 Write property test for Bird_Mark activation equals Primary_CTA
  ...
  - [x] 14.2 Write property test for Quick_Nav routing
  ...
  - [x] 14.3 Write property test for responsive no horizontal overflow
  ...
  - [x] 14.4 Write property test for reduced-motion static final state
  ...
  - [x] 14.5 Write property test for keyboard reachability without a trap
  ...
  - [x] 14.6 Write property test for keyboard activation
  ...
  - [x] 14.7 Write property test for accessible name present
  ...
  - [x] 14.8 Write property test for visible focus indicator
  ...
  - [x] 14.9 Write property test for focus order follows reading order
...
- [x] 15. Example and snapshot tests
  - [x] 15.1 Write example/unit tests for counts, labels, timings, and error branches
  ...
  - [x] 15.2 Write snapshot/visual tests for layout and material fidelity
...
- [x] 16. Final checkpoint — verify the full suite
