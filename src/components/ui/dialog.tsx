...
function DialogPortal({ children }: { children: React.ReactNode }) {
  ...
  // Render into document.body so the dialog escapes any ancestor stacking
  // context (e.g. <main className="z-10">) and reliably layers above the
  // sidebar and other fixed-position chrome.
  ...
  return (
    <DialogPortal>
      ...
      <div
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-[60] grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-background p-6 shadow-lg border border-border",
          className
        )}
      >
        {children}
