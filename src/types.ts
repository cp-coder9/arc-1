export type UserRole = 'client' | 'architect' | 'admin' | 'freelancer' | 'bep' | 'contractor' | 'subcontractor' | 'supplier' | 'developer' | 'engineer' | 'quantity_surveyor' | 'planner' | 'project_manager';
