...
describe('workflow agents', () => {
  ...
  it('enhances tender analysis with risks and BOQ verification', async () => {
    ...
    const bids = [
      { id: 'bid1', tenderPackageId: 't1', contractorId: 'c1', contractorName: 'Low Co', totalAmount: 50, lineItems: [{ description: 'Foundation works', quantity: 1, unitPrice: 50, total: 50 }], proposedTimeline: '4 weeks', proposedStartDate: '2026-01-01', methodology: '', qualifications: '', attachments: [], verificationId: 'contractor-1_contractor_CIDB_CIDB-5GB', status: 'submitted', createdAt: '2026-01-01' },
      { id: 'bid2', tenderPackageId: 't1', contractorId: 'c2', contractorName: 'Mid Co', totalAmount: 100, lineItems: [], proposedTimeline: '5 weeks', proposedStartDate: '2026-01-01', methodology: 'Method', qualifications: 'CIDB', attachments: [], verificationId: 'contractor-1_contractor_CIDB_CIDB-5GB', status: 'submitted', createdAt: '2026-01-01' },
      { id: 'bid3', tenderPackageId: 't1', contractorId: 'c3', contractorName: 'High Co', totalAmount: 120, lineItems: [], proposedTimeline: '6 weeks', proposedStartDate: '2026-01-01', methodology: 'Method', qualifications: 'CIDB', attachments: [], verificationId: 'contractor-1_contractor_CIDB_CIDB-5GB', status: 'submitted', createdAt: '2026-01-01' },
    ] as Bid[];
