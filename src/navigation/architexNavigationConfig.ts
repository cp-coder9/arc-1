...
export const architexNavigation: NavigationItem[] = [
  ...
  },
  {
    key: 'marketplace',
    label: 'Marketplace',
    description: 'Professional commerce layer — discover, transact, and collaborate through verified marketplace modules.',
    ...
    sections: [
      { key: 'projects', label: 'Projects', description: 'Post and discover project opportunities.', roles: ['client', 'developer', 'architect', 'engineer', 'quantity_surveyor', 'town_planner', 'energy_professional', 'fire_engineer', 'bep', 'contractor', 'subcontractor'], supportsContextualMessaging: true },
      { key: 'tasks', label: 'Tasks', description: 'Post and apply for micro-tasks.', roles: ['architect', 'engineer', 'quantity_surveyor', 'town_planner', 'energy_professional', 'fire_engineer', 'bep', 'freelancer', 'contractor', 'subcontractor'], supportsContextualMessaging: true },
      { key: 'suppliers', label: 'Suppliers', description: 'Search and compare SANS-compliant materials.', roles: ['contractor', 'subcontractor', 'supplier'], supportsContextualMessaging: true },
      { key: 'freelancers', label: 'Freelancers', description: 'Discover freelancer profiles and hire.', roles: ['architect', 'engineer', 'quantity_surveyor', 'town_planner', 'energy_professional', 'fire_engineer', 'bep', 'contractor', 'subcontractor', 'freelancer'] },
      { key: 'collaborations', label: 'Collaborations', description: 'Firm team projects and invitations.', roles: ['firm_admin', 'architect', 'bep'] },
      { key: 'search', label: 'Search', description: 'Compliance-first professional search.', roles: ['client', 'developer'] },
    ],
  },
  {
    key: 'finance',
