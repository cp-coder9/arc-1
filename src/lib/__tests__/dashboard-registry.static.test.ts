...
describe('canonical dashboard page registry', () => {
  ...
  it('pins the full role navigation matrix for every canonical role and page', () => {
    ...
    const expectedPagesByRole: Record<string, string[]> = {
      ...
      bep: [...sharedPageIds, 'invoicing', 'directory-search', 'municipal-tracker', 'submission-readiness', 'design', 'drawing-register', 'drawing-checker', 'sans-forms', 'technical-brief', 'bep-marketplace', 'bep-team', 'bep-freelancers', 'snagging', 'procurement', 'knowledge', 'resource-sharing', 'resource-centre', 'cpd-assessment'],
      architect: [...sharedPageIds, 'invoicing', 'directory-search', 'municipal-tracker', 'submission-readiness', 'design', 'drawing-register', 'drawing-checker', 'sans-forms', 'technical-brief', 'bep-marketplace', 'bep-team', 'bep-freelancers', 'snagging', 'procurement', 'knowledge', 'resource-sharing', 'resource-centre', 'cpd-assessment'],
      contractor: [...sharedPageIds, 'invoicing', 'directory-search', 'municipal-tracker', 'submission-readiness', 'snagging', 'construction', 'contractor-staff', 'procurement', 'packages', 'knowledge'],
      ...
      admin: [...sharedPageIds, 'invoicing', 'submission-readiness', 'design', 'drawing-register', 'sans-forms', 'technical-brief', 'snagging', 'construction', 'procurement', 'packages', 'knowledge', 'admin-console'],
    };

    const allPageIds = extractPageIds();
    expect(allPageIds).toHaveLength(40);
