...
// Generated by metaharness — a real smoke test for arc-1-harness.
//
...
// @metaharness/host-opencode is missing, broken, or version-skewed. It is the
...
describe('arc-1-harness — install smoke test', () => {
